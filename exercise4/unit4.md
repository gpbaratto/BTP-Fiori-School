...
Open you implementation class **`ZBP_I_RAP_TRAVEL_####`** you created in exercise 3.
...
You have enhanced the implementation of our managed business object that we have created in exercise 2 and 3, such that 
...
## Solution
Find the source code for the updated interface view, projection view and the behavior implementation in the exercise4/sources folder:
[Sources](sources) or use the following link.

- [W5U5_CLAS_ZBP_I_RAP_TRAVEL_####.txt](/exercise4/sources/W5U5_CLAS_ZBP_I_RAP_TRAVEL_%23%23%23%23.txt) 
- [W5U5_DDLS_ZC_RAP_Travel_####.txt](/exercise4/sources/W5U5_DDLS_ZC_RAP_Travel_%23%23%23%23.txt)
- [W5U5_DDLS_ZI_RAP_Travel_####.txt](/exercise4/sources/W5U5_DDLS_ZI_RAP_Travel_%23%23%23%23.txt)
...
## Next exercise
[Exercise 4 Unit 5: Creating and Previewing the OData UI Service](unit5.md)
